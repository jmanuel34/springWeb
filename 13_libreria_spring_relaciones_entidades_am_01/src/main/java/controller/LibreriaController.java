...
public class LibreriaController {
	...
	public LibreriaController(ClientesService clientesService, LibrosService librosService, VentasService ventasService) {
	...
	public @ResponseBody String misCompras(Model model, SessionAttribute("usuario") String usuario) {

		model.se
		return clienteService.ventaCliente(usuario);
	}
